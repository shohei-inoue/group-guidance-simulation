...
class pseudo_obstacle:
    ...
    def obstacle_linear_regression(self):
        X = self.point_x_list
        Y = self.point_y_list
    ...
    def obstacle_area_formation(self):
        m, n, axis = self.obstacle_linear_regression()
...
def main():
    ...
    # 障害物の作成
    obstacle_list = []
    obstacle1 = Obstacle_square(-50, 40, 10, 100)
    obstacle2 = Obstacle_square(-50, -50, 10, 100)
    obstacle3 = Obstacle_square(-50, -50, 100, 10)
    obstacle4 = Obstacle_square(40, -50, 100, 10)
    ...
    while True:
        if len(marker_list) == 20:
            print("Exploration completed. marker change count 20.")
            break
